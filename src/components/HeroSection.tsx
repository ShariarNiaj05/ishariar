  ...
  return (
    <div>
      ...
      <Spotlight
        ...
        fill="#c2a7ae"
      />
      <div className="h-auto md:h-[40rem] w-full rounded-md flex flex- lg:flex-row items-center justify-center relative overflow-hidden mx-auto py-10 md:py-0">
        <div className="p-4 relative z-10 w-[1/2] text-center">
